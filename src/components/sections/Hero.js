...
export default function Hero() {
  ...
  const getUrgencyMessage = () => {
    ...
    if (isEarlyBird)
      return `Early Bird - ${
        30 - workshopData.totalRegistrations
      } spots left at special price`;
  ...
  return (
    <section
      id="home"
      className="min-h-screen pt-16 bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 overflow-hidden"
    >
          ...
          >
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Shivanshu Soni, fondly known as the Fusion King, is a celebrated
                Indian dancer recognized for seamlessly blending classical grace
                with contemporary expression. With his unique artistry, he
                creates performances that connect tradition with modern rhythm,
            ...
            >
              {!isWorkshopFull ? (
                ...
                <motion.div className="inline-block bg-gray-400 text-white px-8 py-4 rounded-full font-semibold text-lg cursor-not-allowed">
                  Workshop Full
                </motion.div>
              )}
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <p className="text-gray-600">
                    with Shivanshu Soni from Mumbai
                  </p>
                </motion.div>
