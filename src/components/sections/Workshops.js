  ...
  const workshops = [
    {
      ...
      description: "High-energy hip hop workshop focusing on popping, locking, and street style choreography.",
    ...
    },
    {
      ...
      status: "available",
      image: "/api/placeholder/400/300",
      description: "Express your emotions through fluid contemporary movements and storytelling.",
    ...
    },
    {
      ...
      status: "available",
      image: "/api/placeholder/400/300",
      description: "Classic and modern Bollywood choreography with high-energy routines.",
    ...
    },
    {
      ...
      status: "available",
      image: "/api/placeholder/400/300",
      description: "Salsa, bachata, and reggaeton fusion for an explosive dance experience.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">Upcoming Workshops</span>
          </motion.div>
              ...
              >
                ...
                <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                    ...
                    <div className="text-center">
                      ...
                      >
                        <span className="text-white font-bold text-xl">
                          {workshop.choreographer.split(' ').map(n => n[0]).join('')}
                        </span>
                      </motion.div>
                      <p className="text-sm text-gray-500 font-medium">Workshop Preview</p>
                    </div>
                  </div>
                  ...
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.1 }}
                  >
                    <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(workshop.status)}`}>
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <span className="font-medium">with {workshop.choreographer}</span>
                  ...
                  >
                    ...
                    <div className="flex flex-col space-y-2">
                      ...
                      >
                        {workshop.totalSlots - workshop.slotsLeft}/{workshop.totalSlots} registered
                      </motion.div>
                    </div>
                  </motion.div>
                </motion.div>
