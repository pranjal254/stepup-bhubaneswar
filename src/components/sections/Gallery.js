...
import { Play, Heart, Share2, Eye, X, ExternalLink, Download } from 'lucide-react'
...
export default function Gallery() {
  ...
  // Helper function to get LinkedIn image from post URL
  const getLinkedInImage = (url) => {
    // For LinkedIn posts, you would typically use LinkedIn's API or a service
  ...
  const galleryItems = {
    highlights: [
      {
        ...
        views: "2.3K",
        likes: "156",
        url: "https://youtu.be/0WZup9iGQIg?si=_7Hxigm8HBbToY87", // Replace with actual YouTube URL
        thumbnail: "https://yt3.googleusercontent.com/v_9F-TYbShHEsLWnLKODEaM5eJh85ms2WI8Lj68hefdTvS4ry8awK5kd7sfDAti-BoyZBbwZwA=w1707-fcrop64=1,00005a57ffffa5a8-k-c0xffffffff-no-nd-rj",
      ...
      //   views: "1.8K",
      //   likes: "124",
      //   url: "https://www.youtube.com/@vikas_paudel", // Replace with actual image URL
      //   thumbnail: "https://yt3.googleusercontent.com/v_9F-TYbShHEsLWnLKODEaM5eJh85ms2WI8Lj68hefdTvS4ry8awK5kd7sfDAti-BoyZBbwZwA=w1707-fcrop64=1,00005a57ffffa5a8-k-c0xffffffff-no-nd-rj",
      ...
      //   views: "1.5K",
      //   likes: "98",
      //   url: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=600&fit=crop", // Replace with actual image URL
    ...
    behind: [
      ...
      //   views: "892",
      //   likes: "67",
      //   url: "https://images.unsplash.com/photo-1547036967-23d11aacaee0?w=800&h=600&fit=crop", // Replace with actual image URL
      ...
      //   views: "1.2K",
      //   likes: "89",
      //   url: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=800&h=600&fit=crop", // Replace with actual image URL
  ...
  const closeModal = () => {
    ...
    setTimeout(() => setSelectedMedia(null), 300) // Delay to allow exit animation
  }
  ...
  const handleShareClick = (item, e) => {
    ...
    if (navigator.share) {
      navigator.share({
        title: item.title,
        text: `Check out this amazing dance content: ${item.title} by ${item.choreographer}`,
        url: item.url
      })
    } else {
                ...
                <div className="p-6 text-white">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-gray-300 mb-4">by {selectedMedia.choreographer}</p>
                    </div>
                    <div className="flex items-center space-x-4">
                      <motion.button
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        onClick={(e) => handleShareClick(selectedMedia, e)}
                      >
                        <Share2 size={16} />
