...
export const metadata = {
  ...
  title: 'Step Up Bhubaneswar - Dance Workshops with Top Choreographers | Hip Hop, Bollywood, Contemporary',
  description: 'Join Odisha\'s first curated dance workshop platform. Learn from India\'s top choreographers in weekend sessions. Hip Hop, Bollywood, Contemporary & Latin dance classes for all levels in Bhubaneswar. No age limit, no experience required.',
  keywords: 'dance workshops Bhubaneswar, Step Up Bhubaneswar, choreography workshops Odisha, hip hop workshops Bhubaneswar, Bollywood dance classes, weekend dance classes, professional dance training, contemporary dance workshops, beginner dance classes, dance academy Bhubaneswar, celebrity choreographer workshops, Mumbai choreographers, dance for all ages, cultural dance hub Odisha, premium dance workshops, dance community Bhubaneswar, intensive dance training, Latin dance workshops, salsa bachata classes, dance fitness classes, creative expression dance, working professionals dance, dance masterclass, national level instructors',
  
  // Open Graph for social sharing
  openGraph: {
    title: 'Step Up Bhubaneswar - Premium Dance Workshops with Celebrity Choreographers',
    description: 'Weekend dance workshops with top choreographers from Mumbai, Delhi & across India. All dance styles, all levels welcome. Join Odisha\'s dance revolution!',
    type: 'website',
    locale: 'en_IN',
  ...
  twitter: {
    ...
    description: 'Learn from India\'s best choreographers in weekend dance workshops. Hip Hop, Bollywood, Contemporary & more!',
  ...
  other: {
    ...
    'DC.description': 'Professional dance workshop platform bringing top choreographers to Bhubaneswar',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Odisha's first curated dance workshop platform with top choreographers from across India",
              "url": "https://stepupbhubaneswar.com",
